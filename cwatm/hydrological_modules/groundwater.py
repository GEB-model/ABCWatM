    ...
    **Functions**
    ...
    def initial(self):
        ...
        * initial groundwater storage
        ...
        # for CALIBRATION
        self.var.recessionCoeff = (
            1 / self.var.recessionCoeff * loadmap("recessionCoeff_factor")
        )
        ...
        self.var.recessionCoeff = np.maximum(5.0e-4, self.var.recessionCoeff)
        ...
        self.var.storGroundwater = (
            np.maximum(3.0, self.var.storGroundwater) + globals.inZero
        )  # Establishing initial storGroundwater
    ...
    def dynamic(self):
        ...
        self.var.storGroundwater = np.maximum(
            0.0,
            self.var.storGroundwater
        ...
        self.var.storGroundwater = (
            self.var.storGroundwater - self.var.baseflow - self.var.capillar
        )

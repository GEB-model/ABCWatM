...
# --------------------------------------------------------------------------
    ...
    def dynamic(self, openWaterEvap, channel_abstraction_m, returnFlow):
        ...
        * calculate kinematic wave -> using C++ library for computational speed
        ...
        EWRefact = self.var.lakeEvaFactor * self.model.data.to_var(landunit_data=self.model.data.landunit.EWRef, fn='mean') - self.model.data.to_var(landunit_data=openWaterEvap, fn='mean')  # checked
        ...
        if checkOption('includeWaterBodies'):
            ...
            fraction_water = self.model.data.to_var(landunit_data=fraction_water, fn='sum')

    ...
    **Functions**
    ...
    def initWaterbodies(self):
        ...
        if checkOption('includeWaterBodies'):
            ...
            self.var.waterBodyTypC = water_body_data.loc[self.var.waterBodyIDC]['waterbody_type'].values
            ...
            self.var.lakeAreaC = water_body_data.loc[self.var.waterBodyIDC]['average_area'].values
            ...
            self.var.lakeDis0C = np.maximum(water_body_data.loc[self.var.waterBodyIDC]['average_discharge'].values, 0.1)
    ...
    def dynamic_inloop(self, NoRoutingExecuted):
        ...
        * reservoirs with special filling levels
        ...
        def dynamic_inloop_lakes(inflowC, NoRoutingExecuted):
            ...
            if checkOption('calcWaterBalance'):
                self.model.waterbalance_module.waterBalanceCheck(
                    ...
                    outfluxes=[self.var.lakeOutflowC ,self.var.lakeEvapWaterBodyC /self.var.dtRouting]  ,  # Out  self.var.evapWaterBodyC
            ...
            if checkOption('calcWaterBalance'):
                ...
                self.model.waterbalance_module.waterBalanceCheck(
                    ...
                    outfluxes=[self.var.lakeOutflowC ,self.var.lakeEvapWaterBodyC /self.var.dtRouting, lakedaycorrectC / self.var.dtRouting ]  ,  # Out  self.var.evapWaterBodyC
                    prestorages=[oldlake / self.var.dtRouting],  # prev storage
                    poststorages=[self.var.lakeStorageC /self.var.dtRouting],
                    name="lake2",
                    tollerance=1e-7)
            ...
            if checkOption('calcWaterBalance'):
                self.model.waterbalance_module.waterBalanceCheck(
                    ...
                    outfluxes=[QLakeOutM3DtC ,self.var.lakeEvapWaterBodyC, lakedaycorrectC]  ,  # Out  self.var.evapWaterBodyC
        ...
        def dynamic_inloop_reservoirs(inflowC, NoRoutingExecuted):
            ...
            if checkOption('calcWaterBalance'):
                self.model.waterbalance_module.waterBalanceCheck(
                    ...
                    outfluxes=[qResOutM3DtC /self.var.dtRouting ,self.var.resEvapWaterBodyC /self.var.dtRouting]  ,  # Out  self.var.evapWaterBodyC
        ...
        dis_LR = np.where(self.var.waterBodyID > 0, dis_LR, 0.) * self.model.DtSec
        ...
        lakeResOutflowDis = npareatotal(self.var.reslakeoutflow, self.var.waterBodyID) / (self.model.DtSec / self.var.noRoutingSteps)
        ...
        if self.var.noRoutingSteps == (NoRoutingExecuted + 1) and checkOption('calcWaterBalance'):
            self.model.waterbalance_module.waterBalanceCheck(
                how='cellwise',
            ...
            self.model.waterbalance_module.waterBalanceCheck(
                ...
                outfluxes=[self.var.sumlakeResOutflow , self.var.sumEvapWaterBodyC]  ,  # Out  self.var.evapWaterBodyC
                prestorages=[np.compress(self.var.compress_LR, self.var.prelakeResStorage)] ,  # prev storage
                poststorages=[self.var.lakeResStorageC],
                tollerance=1000)
            self.model.waterbalance_module.waterBalanceCheck(
                how='cellwise',

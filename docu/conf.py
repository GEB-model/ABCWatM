...
pdf_documents = [
    ("index", "CWATM", "CommunityWaterModel_V-1,1", "Peter Burek"),
]
...
#
html_title = "Community Water Model"
...
man_pages = [(master_doc, "CWATM", "CWATM Documentation", [author], 1)]
